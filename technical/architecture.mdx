...
graph TD
    ...
    subgraph "Core Contracts"
        DaoSign[DaoSign.sol]
        DaoSignV2[DaoSignV2.sol]
        DaoSign -->|Upgrades to| DaoSignV2
    end
...
An upgraded version of the core contract that adds:

- Version tracking
- Enhanced functionality (as needed)
- Backward compatibility with DaoSign.sol
